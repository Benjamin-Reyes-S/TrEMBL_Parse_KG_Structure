...
IMPORTS = [
    ...
    (
        ...
        "CREATE (c:TrEMBL_Citation {title_and_date: row.title_and_date}) "
    ...
    (
        ...
        "RETURN row",
        "MATCH (p:TrEMBL_Protein {accession: row.protein_accession}) "
        "MATCH (o:TrEMBL_Organism {taxonomy_id: row.organism_taxonomy_id}) "
    ...
    (
        ...
        "RETURN row",
        "MATCH (p:TrEMBL_Protein {accession: row.protein_accession}) "
        "MATCH (c:TrEMBL_Citation {title_and_date: row.citation_title_and_date}) "
